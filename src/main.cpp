...
uint256 hashGenesisBlock("0x4581101e1eaebab80901594b085eb143c02cb35ba0cb310f9077061f76e61193");
static CBigNum bnProofOfWorkLimit = CBigNum().SetCompact(537261531); // GOONIES: starting difficulty is 1 / 2^12
...
const string strMessageMagic = "GOONIES Signed Message:\n";
...
{
    // GOONIES: IsDust() detection disabled, allows any valid dust to be relayed.
...
{
    int64 nSubsidy = 36800000000;

    // Subsidy is cut in half every 368,038 blocks, which will occur approximately every 255 days
    nSubsidy >>= (nHeight / 368038); // GOONIES: 368,038 blocks in ~255 days

    return nSubsidy + nFees;
}

static const int64 nTargetTimespan = 300; // GOONIES: 5 minutes
static const int64 nTargetSpacing = 60; // GOONIES: 1 minute
...
unsigned int static GetNextWorkRequired(const CBlockIndex* pindexLast, const CBlockHeader *pblock)
{
    ...
    // GOONIES: This fixes an issue where a 51% attack can change difficulty at will.
...
bool CBlock::CheckBlock(CValidationState &state, bool fCheckPOW, bool fCheckMerkleRoot) const
{
    ...
    // GOONIES: Special short-term limits to avoid 10,000 BDB lock limit:
...
{
    // GOONIES: temporarily disable v2 block lockin until we are ready for v2 transition
    return false;
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0xf6ce694d03c5646e80bad3409c6f78942f4c2ca91f559b61e139f0396dcf76c7");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        // Genesis block
        const char* pszTimestamp = "First you gotta do the truffle shuffle";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        txNew.vin[0].scriptSig = CScript() << 486604799 << CBigNum(4) << vector<unsigned char>((const unsigned char*)pszTimestamp, (const unsigned char*)pszTimestamp + strlen(pszTimestamp));
        txNew.vout[0].nValue = 36800000000;
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("90260680cf18ee145a22357de28b07d5e3d8f7b09caf34afc7dbe474e09599d582deadb3ee0af5df2222c0ba92cd1c83d27df1dc2e8552af6e0a6f7ff8b2afdfd6") << OP_CHECKSIG;
        CBlock block;
        block.vtx.push_back(txNew);
        block.hashPrevBlock = 0;
        block.hashMerkleRoot = block.BuildMerkleTree();
        block.nVersion = 1;
        block.nTime    = 1469889558;
        block.nBits    = 537261531;
        block.nNonce   = 1017145093;

        if (fTestNet)
        {
            block.nTime    = 1469889558;
            block.nNonce   = 2299018214;
        }
        ...
        assert(block.hashMerkleRoot == uint256("0x1360c5024471cb2a1c07ae1b0676557114cd6efafe933f70ac02966628de4126"));
        block.print();
...
unsigned char pchMessageStart[4] = { 0xfb, 0xc0, 0xb6, 0xdb }; // GOONIES: increase each by adding 2 to bitcoin's value.
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("GOONIESMiner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("GOONIESMiner : ProcessBlock, block not accepted");
    }
